function changeForMobile(page)
{
    if (page == 'home')
    {
        ...
        $('#webBody2').append('<div><ul id=midsecUL><li id=midsecLIT style=font-size:larger;><h4><b>Recent Website Release:</b></h4></li><li id=midsecLIG style=margin:0;padding:0;><h2><b>BookSafe</b></h2></li><li id=midsecLI>Type: Tool</li><li id=midsecLI>Released: 13 July 2022</li><li id=midsecLI><a id=link style=text-decoration:underline; href=https://git-horizonzz.github.io/booksafe/ target=_blank rel="noopener noreferrer">git-horizonzz.github.io/booksafe</a></li></ul><ul id=midsecUL><li id=midsecLIT><img width=300px height=300px src=images/lockicon.png height=200px></li></ul></div>')
    }
    if (page == 'portfolio') 
    {
